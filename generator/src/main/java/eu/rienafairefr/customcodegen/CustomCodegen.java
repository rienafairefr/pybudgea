...
public class CustomCodegen extends DefaultCodegen implements CodegenConfig {
    private static final Logger LOGGER = LoggerFactory.getLogger(CustomCodegen.class);
    ...
    public CustomCodegen() {
        ...
        modelPackage = "schemas";
        apiPackage = "api";
        outputFolder = "generated-code" + File.separatorChar + "customcodegen";

        modelTemplateFiles.put("schema.mustache", ".py");

        embeddedTemplateDir = templateDir = "customcodegen";
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile("__init__schema.mustache", packagePath() + File.separatorChar + modelPackage, "__init__.py"));
